...
import { CATEGORIES, PRODUCTS } from '@/features/search/constants/search';
import { useSearchParams } from 'next/navigation';

export default function SearchPage() {
  const searchParams = useSearchParams();
  const main = searchParams.get('main') || '베스트';
  const sub = searchParams.get('sub') || '전체보기';

  const currentCategory = CATEGORIES.find((c) => c.label === main);
  ...
  return (
    <div className="min-h-screen bg-white pb-20">
      ...
      <div className="px-[150px]">
        ...
        <SubCategorybar categories={currentCategory?.subcategories || []} main={main} sub={sub} />
